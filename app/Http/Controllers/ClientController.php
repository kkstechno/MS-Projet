...
class ClientController extends AppBaseController
{
    ...
    public function store(CreateClientRequest $request)
    {
        ...
        return $this->sendSuccess('Partenaire créé avec succès.');
    }
    ...
    public function show(Client $client)
    {
        ...
        return $this->sendResponse($client, 'Partenaire récupéré avec succès.');
    }
    ...
    public function update(Client $client, UpdateClientRequest $request)
    {
        ...
        return $this->sendSuccess('Partenaire mis à jour avec succès.');
    }
    ...
    public function destroy(Client $client)
    {
        ...
        return $this->sendSuccess('Partenaire supprimé avec succès.');
    }
    ...
    public function storeClients(CreateClientRequest $request)
    {
        ...
        return $this->sendResponse($data, 'Partenaire créé avec succès.');
    }
}
