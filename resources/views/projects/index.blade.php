...
@section('content')
    <section class="section">
        ...
        <div class="section-header">
            <h1 class="page__heading">{{ __('Liste des projets') }}</h1>
            <div class="filter-container section-header-breadcrumb d-block d-md-flex">
                <div class="mr-3 align-items-center">
                    <label for="clients" class="lbl-block mr-2"><b>{{ __('Partenaires') }}</b></label>
                    {{Form::select('drp_client',$clients,null,['id'=>'filterClient','class'=>'form-control', 'placeholder' => 'Tous'])  }}
                </div>
                <a href="#" class="btn btn-primary filter-container__btn mt-4 float-right" data-toggle="modal"
                   data-target="#AddModal"><i class="fas fa-plus"></i>&nbsp;{{ __('Nouveau projet') }}</a>
            </div>
        </div>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">{{ __('Modifier le responsable') }}</h5>
