            ...
            <div class="row project-details-card">
                <div class="col-md-8">
                    ...
                    <div class="card-body pt-1">
                        <label class="mb-2 font-weight-bold">{{__('Description du projet')}} : </label>
                        <div class="project-description">
                            {!! (!empty($project->description)) ? html_entity_decode($project->description) : __('Aucune information') !!}
                        </div>
                    </div>
                    <hr>
                    <div class="card-body pt-0">
                        <div class="row">
                            <div class="col-md-4">
                                <label class="font-weight-bold">{{__('L\'avancement du projet')}}</label><br>
                            ...
                            <div class=" col-md-4">
                                {{ Form::label('created_at', __('Crée il y a'),['class' => 'font-weight-bold']) }}
                                <br>
                            ...
                            <div class="col-md-4">
                                {{ Form::label('updated_on', __('Dernière Mise à jour'),['class' => 'font-weight-bold']) }}
                                <br>
                                <p><span data-toggle="tooltip" data-placement="right"
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card card-statistic-2 project-details-box">
                    ...
                    <div class="card-wrap">
                        <div class="card-header pt-3">
                            <label>{{__('Tâches')}}</label>
                        </div>
                        <div class="card-body">
                            {{count($project->openTasks)}}/{{count($project->tasks)}}
                            <span>{{__('Tâches en attente')}}</span>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            @forelse($activities as $activity)
                                <div class="row">
                                    ...
                                    <div class="col-sm-11 form-group pl-0 mb-2">
                                        ...
                                        <label class="font-size-14px">{{ !empty($activity->createdBy) ? $activity->createdBy->name : __('non-préciser') }} {{ html_entity_decode($activity->description) }}</label>
                                    </div>
                                </div>
                            @empty
                                <div class="mt-0 mb-5 col-12 d-flex justify-content-center  mb-5 rounded">
                                    <div class="row">
                                        <div class="empty-state col-sm-12" data-height="400">
                                            ...
                                            <h2>{{__('Aucune tâche en attente disponible pour ce projet')}}</h2>
                                        </div>
                                    </div>
                                </div>
                            @endforelse
    ...
    <div class="row">
        <div class="col-lg-8 col-sm-12">
            <div class="mb-3 d-flex">
                <span class="project-detail__attachment-heading w-100">{{ __('Fichiers joints') }}:</span>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div>
                    <a href="#" data-id="{{$project->id}}" class="btn btn-primary filter-container__btn float-right"
                       id="addTask">{{ __('Nouvelle tâche') }}</a>
                </div>
                <div class="card-body pt-0">
