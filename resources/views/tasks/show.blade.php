...
@section('content')
    <section class="section">
        ...
        <div class="section-header">
            <h1 class="page__heading">{{ __('Détails de la tâche') }}</h1>
            <div class="filter-container section-header-breadcrumb">
                <div class="ml-auto">
                    ...
                    <a class="btn btn-light" href="{{ route('tasks.index') }}">{{ __('Retour') }}</a>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row task-detail">
                                        @if(!empty($task->taskAssignee->pluck('name')->toArray()))
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label
                                                            class="font-weight-bold">{{ __('Assignation') }}
                                                        :</label>
                                        ...
                                        @if(!empty($task->due_date))
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label
                                                            class="font-weight-bold">{{ __('Date d\'échéance') }}
                                                        :</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="font-weight-bold">{{ __('Statut') }}
                                                    :</label>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label
                                                            class="font-weight-bold">{{ __('Priorité') }}
                                                        :</label>
                                                    <p>
                                            ...
                                            @if(!empty($task->tags->pluck('name')->toArray()))
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label
                                                                class="font-weight-bold">{{ __('Mots-clés') }}
                                                            :</label><br>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label
                                                        class="font-weight-bold">{{ __('Suivi du temps') }}
                                                    : </label><br>
                                                <span class="pointer">
                                                    <span>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label
                                                            class="font-weight-bold">{{ __('Crée par') }}
                                                        </label>
                                            ...
                                            @if(!empty($task->estimate_time))
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="font-weight-bold">{{__('Temps estimé')}}
                                                            </label>
                                                        <p class="flex-1">
                                                            @if($task->estimate_time_type == \App\Models\Task::IN_HOURS)
                                                                <?php
                                                                    $values = explode(':', $task->estimate_time);
                                                                    $hours = (isset($values[0]) && $values[0] != 0) ? $values[0].' '.__('H') : '';
                                                                    $minutes = (isset($values[1]) && $values[1] != 0) ? ' '.$values[1].' '.__('mn') : '';
                                                                ?>
                                                                {{ $hours.$minutes }}
                                                            @else
                                                                {{ $task->estimate_time.' '.__('Jours')  }}
                                                            @endif
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    {{ Form::label('created_at', __('Crée le'),['class'=>'font-weight-bold']) }}
                                                    <br>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    {{ Form::label('created_at', __('Dernière Mise à jour'),['class'=>'font-weight-bold']) }}
                                                    <br>
                                                    <span data-toggle="tooltip" data-placement="right"
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="font-weight-bold">{{ __('Description') }}
                                                        </label><br>
                                                    <span>
                                                        {!! !empty($task->description) ? html_entity_decode($task->description) : __('non-defini') !!}
                                                    </span>
                                                </div>
                                            </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 col-sm-12">
                                            <div class="mb-3 d-flex">
                                                <span
                                                        class="task-detail__attachment-heading w-100">{{ __('Pièces jointes') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="tab-pane fade" id="tComments" role="tabpanel" aria-labelledby="taskComment">
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            <strong>{{ Form::label('add_comment', __('Ajouter commentaire')) }}</strong>
                                            <div id="commentContainer" class="quill-editor-container"></div>
                                            <div class="text-left mt-3">
                                                {{ Form::button(__('Enregistrer'), ['type'=>'button','class' => 'btn btn-success', 'id'=>'btnComment', 'data-edit-mode' => '0', 'data-comment-id' => '0', 'data-loading-text'=>"<span class='spinner-border spinner-border-sm'></span> Validation..."]) }}
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="card task-chat-box comments" id="mychatbox">
                                                <div>
                                                    <div class="mb-3 d-flex">
                                                        <span class="flex-1 ml-5 no_comments text-center @if(!($task->comments->isEmpty())) d-none @endif">{{ __('Aucun commentaire ajouté') }}</span>
                                                    </div>
                                                </div>
                                                <div id="itemsWrapper"
                                                                        ...
                                                                        <div class="dropdown-list-content dropdown-list-icons">
                                                                            <a href="#"
                                                                               ...
                                                                               data-id="{{ $comment->id }}"><i
                                                                                        class="fas fa-edit mr-2 card-edit-icon"></i>{{ __('Editer') }}
                                                                            </a>
                                                                            <a href="#"
                                                                               class="dropdown-item dropdown-item-desc del-comment"
                                                                               data-id="{{ $comment->id }}"><i
                                                                                        class="fas fa-trash mr-2 card-delete-icon"></i>{{ __('Supprimer') }}
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                    ...
                                    <div class="task-time-entry-table">
                                        <div class="filter-container section-header-breadcrumb d-flex">
                                            <a href="#"
                                               ...
                                               data-id="{{ $task->id }}"
                                               data-project-id={{$task->project->id}}>{{ __('Nouvelle Entrée') }}
                                                <i class="fas fa-plus"></i></a>
                                            <div class="mr-3 mb-2">
                                                {{ Form::select('drp_activity',$activityTypes,null,['id'=>'filterActivity','class'=>'form-control', 'placeholder' => 'Type d\'activité'])  }}
                                            </div>
                                            <div class="mr-2 align-items-center mt-3 mt-lg-0">
                                                <div id="time_range" class="time_range date_range_task_time_entry">
                                                    <i class="far fa-calendar-alt"
                                                       aria-hidden="true"></i>&nbsp;&nbsp;<span></span> <b class="caret"></b>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <table class="table table-responsive-lg table-striped table-bordered"
                                                ...
                                                <tr>
                                                    <th></th>
                                                    <th>{{ __('Type d\'activité') }}</th>
                                                    <th>{{ __('Date Début') }}</th>
                                                    <th>{{ __('Date Fin') }}</th>
                                                    <th>{{ __('Durée') }}</th>
                                                    <th>{{ __('Type') }}</th>
                                                    <th>{{ __('Crée le') }}</th>
                                                    <th class="w-10">{{ __('Actions') }}</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                </tbody>
