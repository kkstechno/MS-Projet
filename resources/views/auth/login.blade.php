...
<title>Connexion | MS-Projet</title>
@section('css')
...
@section('content')
    <div class="row login-container">
        <div class="col-md-6 img-box">
            <img src="{{asset('assets/img/desktop.gif')}}" width="100%">
        </div>
        <div class="col-md-5">
                    ...
                    <form method="post" action="{{ url('/login') }}">
                        ...
                        <div class="login-row row no-margin">
                            ...
                            <input type="email"
                                   ...
                                   placeholder="Entrer votre E-mail" autofocus tabindex="1">
                        ...
                        <div class="login-row row no-margin">
                            ...
                            <input type="password"
                                   ...
                                   name="password"
                                   placeholder="Entrer votre mot de passe" tabindex="2">
                            <div class="invalid-feedback">
                        ...
                        <div class="login-row row">
                            <p class="ml-4"><input type="checkbox" name="remember" tabindex="3"
                                ...
                                &nbsp;Se souvenir</p>
                            <p class="ml-auto"><a href="#" class="text-small" tabindex="4">
                                    Mot de passe oublié?
                                </a>
                            </p>
                        </div>
