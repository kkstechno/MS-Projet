@can('manage_department')
    <li class="side-menus {{ Request::is('departments*') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('departments.index') }}">
            <i class=" fas fa-building"></i><span>{{ __('Départements') }}</span>
        </a>
    </li>
@endcan
...
@can('manage_clients')
    <li class="side-menus {{ Request::is('clients*') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('clients.index') }}">
            <i class="fas fa-user-tie" aria-hidden="true"></i><span>{{ __('Partenaires') }}</span>
        </a>
    </li>
@endcan
...
<li class="side-menus {{ Request::is('projects*') || Request::is('user-assign-projects*') ? 'active' : '' }}">
    <a class="nav-link" href="{{ route('projects.index') }}">
        <i class="fas fa-folder-open" aria-hidden="true"></i><span>{{ __('Projets') }}</span>
    </a>
</li>
@endcan
...
@can('manage_reports')
    <li class="side-menus {{ Request::is('report*') ? 'active' : '' }}">
        <a class="nav-link" href="{{ url('reports') }}">
            <i class="fas fa-file " aria-hidden="true"></i><span>{{ __('Rapports') }}</span>
        </a>
    </li>
@endcan
@canany(['manage_users','archived_users'])
    <li class="side-menus nav-item dropdown">
        <a href="#" class="nav-link has-dropdown"><i class="fas fa-users"></i>
            <span>{{__('Membres')}}</span></a>
        <ul class="dropdown-menu side-menus">
            @can('manage_users')
            <li class="side-menus {{ Request::is('users*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('users.index') }}">
                    <i class="fas fa-user " aria-hidden="true"></i><span>{{ __('Comptes') }}</span>
                </a>
            </li>
            @endcan
            @can('archived_users')
            <li class="side-menus {{ Request::is('archived-users*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('archived-users') }}">
                    <i class="fas fa-users-slash" aria-hidden="true"></i><span>{{ __('Archivés') }}</span>
                </a>
            </li>
            @endcan
        </ul>
...
@canany(['manage_invoices','manage_expenses'])
    <li class="side-menus nav-item dropdown">
        <a href="#" class="nav-link has-dropdown"><i class="fas fa-wallet"></i>
            <span>{{__('Finance')}}</span></a>
        <ul class="dropdown-menu side-menus">
            @can('manage_invoices')
                <li class="side-menus {{ Request::is('invoice*') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ url('invoices') }}">
                        <i class="fas fa-file-invoice " aria-hidden="true"></i><span>{{ __('Factures') }}</span>
                    </a>
                </li>
            @endcan
            @can('manage_expenses')
                <li class="side-menus {{ Request::is('expenses*') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('expenses.index') }}">
                        <i class="fas fa-rupee-sign" aria-hidden="true"></i><span>{{__('Frais')}}</span></a>
                </li>
            @endcan
        </ul>
    </li>
        ...
        <ul class="dropdown-menu side-menus">
            ...
            <li class="side-menus {{ Request::is('activity-logs*') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('activity-logs') }}">
                    ...
                    aria-hidden="true"></i><span>{{ __('Journal') }}</span>
                </a>
            </li>
            @endcan
            @can('manage_taxes')
                <li class="side-menus {{ Request::is('taxes*') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('taxes.index') }}">
                        <i class="fas fa-percent " aria-hidden="true"></i><span>{{ __('Taxes') }}</span>
                    </a>
                </li>
            @endcan
            @can('manage_roles')
                <li class="side-menus {{ Request::is('roles*') ? 'active' : '' }}">
                    <a class="nav-link" href="{{ url('roles') }}">
                        <i class="fas fa-user " aria-hidden="true"></i><span>{{ __('Rôles') }}</span>
                    </a>
                </li>
            @endcan
            @can('manage_settings')
                    <li class="side-menus {{ Request::is('settings*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('settings.edit') }}">
                            <i class="fas fa-user-cog "
                               aria-hidden="true"></i><span>{{ __('Réglages') }}</span>
                        </a>
                    </li>
            @endcan
        </ul>
...
@can('manage_calendar_view')
    <li class="side-menus {{ Request::is('time-entries-calendar*') ? 'active' : '' }}">
        <a class="nav-link" href="{{ url('time-entries-calendar') }}">
            <i class="fas fa-calendar-alt" aria-hidden="true"></i><span>{{ __('Calendrier') }}</span>
        </a>
    </li>
@endcan