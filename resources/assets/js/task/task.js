        ...
        },
        {
            data: function (row) {
                ...
                let actionString =
                    ...
                    '<a title="Editer" class="btn action-btn btn-primary btn-sm mr-1 task-edit-btn" data-id="' +
                    row.id + '">' +
                    '<i class="cui-pencil action-icon"></i>' + '</a>' +
                    '<a title="Supprimer" class="btn action-btn btn-danger btn-sm btn-task-delete" data-task-id="' +
                    row.id + '">' +
